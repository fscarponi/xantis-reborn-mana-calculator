    ...
    <>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 items-start">
        ...
        <div className="bg-slate-900/50 border border-slate-700 rounded-md p-4 flex flex-col items-center justify-center h-full">
           ...
           <button onClick={handleRoll} className="w-full bg-cyan-600 text-white font-bold py-2 px-4 rounded-md transition-colors hover:bg-cyan-500 disabled:bg-slate-600 disabled:opacity-50">
             Tira i Dadi!
           </button>
           {rollResult && (
